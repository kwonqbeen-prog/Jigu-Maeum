    ...
    <div className="flex min-h-svh flex-col bg-surface lg:mx-auto lg:max-w-[480px]">
      ...
      <div className="flex-1 space-y-6 px-4 py-6">
        ...
        <Section label="어떻게 작동해요">
          <p>
            매일 체크인에서 알려주신 감정과 오늘의 의욕, 그동안의 실천 이력을 바탕으로 AI(Upstage Solar)가 지금
            당신에게 맞는 미션 3가지를 새로 만들어드려요. 같은 기분이어도 어제와 똑같은 제안을 받지 않도록, 최근에
            해본 실천과 겹치지 않게 매번 다시 생각해서 골라요.
          </p>
          <p>
            실천을 쌓아갈수록 마음 지구가 조용한 지구에서 빛나는 지구까지 함께 자라나요. 회원 정보와 실천 기록은
